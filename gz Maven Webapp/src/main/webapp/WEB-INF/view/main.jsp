    ...
    <div class="layui-side layui-bg-black"  style="top:0px;background-color: #33b7b1!important;">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="fa fa-diamond fa-lg"></i> <span >客户节报表</span></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a data-url="khjgoods.do" data-id="29" data-title="品种分析" class="site-demo-active"  href="javascript:;" data-type="tabAdd">品种分析</a></dd>
                                           ...
                                           <dd><a data-url="khjcust.do" data-id="30" data-title="新增客户分析" class="site-demo-active"  href="javascript:;" data-type="tabAdd">新增客户分析</a></dd>
                        <!--
                      ...
                      <dd><a data-url="khjspml.do" data-id="33" data-title="商品上架分析" class="site-demo-active"  href="javascript:;" data-type="tabAdd">商品上架分析</a></dd>
                        <!--
                              ...
                              -->
                                                                       ...
                                                                       <dd><a data-url="khjsankey.do" data-id="37" data-title="流程效率分析" class="site-demo-active"  href="javascript:;" data-type="tabAdd">流程效率分析</a></dd>
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="fa fa-diamond fa-lg"></i> <span >客户节任务</span></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd><a data-url="khjtask/task" data-id="25" data-title="任务管理" class="site-demo-active"  href="javascript:;" data-type="tabAdd">任务登记</a></dd>
