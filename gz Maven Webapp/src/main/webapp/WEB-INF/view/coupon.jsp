    ...
    <script  >
        ...
        $(document).ready(function(){
                ...
                $("a[id$='export']").click(function(){
                    ...
                    window.location.href="exportcoupon?"+"begin_date="+content1.value+"&end_date="+content2.value;
                    showLoading();
                    return true;
                });
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    ...
    <tr valign="top">
        <td height="30">
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr>
                    <td class="fftd">
                        <form name="couponform" method="post" id="form" action="coupon.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">

                                <tr>
                                    <td class="font3">
                                        开始日期：<input type="text" id="begin_date" name="begin_date" value="${coupon_con.begin_date}"  />
                                        结束日期：<input type="text" id="end_date"   name="end_date" value="${coupon_con.end_date}" />
    ...
    <tr><td>
        ...
        <%
            ...
            chartConfig.put("caption", "优惠券使用情况");
            chartConfig.put("subCaption", "");
            chartConfig.put("xAxisName", "优惠券类型");
            chartConfig.put("yAxisName", "毛利率(%)");
            ...
            //遍历List
            Object re = request.getAttribute("coupon");
            List<Top10Cust> ol= (List)re;
            for(int i=0;i<ol.size();i++){
                Top10Cust      ov = ol.get(i);


                dataValuePair.put(""+ov.getCoupon()+"", ov.getCankmll());
    ...
    <tr valign="top">
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
                ...
                <c:forEach items="${requestScope.coupon}" var="coupon" varStatus="stat">
