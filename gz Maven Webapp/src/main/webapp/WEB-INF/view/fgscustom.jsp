...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2">&nbsp;&nbsp;&nbsp;当前位置：配置 &gt; 无资料分公司转总部客户</td>
        <td width="15" height="32"></td>
    </tr>
</table>
        ...
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
                ...
                <c:forEach items="${requestScope.fgscustom}" var="fgscustom" varStatus="stat">
                    ...
                    <td>${fgscustom.kehulb    } </td>
                    <td>${fgscustom.wldwid   }</td>
                    <td>${fgscustom.wldwbh    } </td>
                    <td>${fgscustom.wldwname  } </td>
                    <td>${fgscustom.lxdh     }  </td>
                    <td>${fgscustom.lxr      }  </td>
                    <td>${fgscustom.ds_lxr   }  </td>
                    <td>${fgscustom.ds_lxdh  }  </td>
