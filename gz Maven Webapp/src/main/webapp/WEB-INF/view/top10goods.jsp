    ...
    <script  >
        ...
        $(document).ready(function(){
                ...
                $("a[id$='export']").click(function(){
                    ...
                    window.location.href="exporttop10goods?"+"begin_date="+content1.value+"&end_date="+content2.value;
                    showLoading();
                    return true;
                });
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
    ...
    <tr valign="top">
        <td height="30">
            <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                <tr>
                    <td class="fftd">
                        <form name="top10goodsform" method="post" id="form" action="top10goods.do">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">

                                <tr>
                                    <td class="font3">
                                        开始日期：<input type="text" id="begin_date" name="begin_date" value="${top10goods_con.begin_date}"  />
                                        结束日期：<input type="text" id="end_date"   name="end_date" value="${top10goods_con.end_date}" />
    ...
    <tr><td>
        ...
        <%
            ...
            chartConfig.put("caption", "销售品种Top10");
            chartConfig.put("subCaption", "");
            chartConfig.put("xAxisName", "商品名称");
            ...
            //遍历List
            Object re = request.getAttribute("top10goods");
            List<Top10Cust> ol= (List)re;
            for(int i=0;i<ol.size();i++){
                Top10Cust      ov = ol.get(i);


                dataValuePair.put(""+ov.getSpmch()+"", ov.getHsje());
    ...
    <tr valign="top">
        <td height="20">
            <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
                ...
                <c:forEach items="${requestScope.top10goods}" var="top10goods" varStatus="stat">
                    <tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">

                        <td>${top10goods.spmch                       }</td>
                        <td>${top10goods.hsje                 }</td>
                        <td>${top10goods.cankml                 }</td>
                        <td>${top10goods.cankmll                   }</td>
